    ...
    <section id="about" className="py-20 sm:py-28 bg-cream">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-16">
          <div>
            <h3 className="text-2xl font-light text-brown mb-4">Unparalleled Comfort</h3>
          ...
          <div>
            <h3 className="text-2xl font-light text-brown mb-4">Culinary Excellence</h3>
            <p className="text-gray-700 font-light leading-relaxed mb-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          <div>
            <h3 className="text-2xl font-light text-brown mb-4">Privacy & Serenity</h3>
            <p className="text-gray-700 font-light leading-relaxed mb-4">
          ...
          <div>
            <h3 className="text-2xl font-light text-brown mb-4">Strategic Location</h3>
            <p className="text-gray-700 font-light leading-relaxed mb-4">
