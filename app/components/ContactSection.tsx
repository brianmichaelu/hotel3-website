    ...
    <section id="contact" className="py-20 sm:py-28 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          {/* Contact Info */}
          <div>
            <h3 className="text-2xl font-light text-brown mb-8">Contact Details</h3>

            <div className="mb-8">
              <h4 className="text-lg font-light text-brown mb-4">Mobile / WhatsApp</h4>
              <a
            ...
            <div className="mb-8">
              <h4 className="text-lg font-light text-brown mb-4">Email</h4>
              <a
            ...
            <div className="bg-cream p-8 rounded-lg">
              <h4 className="text-lg font-light text-brown mb-4">Quick Response</h4>
          ...
          <div>
            <form onSubmit={handleSubmit} className="bg-cream p-8 rounded-lg">
              <div className="mb-6">
                <label className="block text-sm font-light text-brown mb-2">Full Name *</label>
                <input
                  type="text"
                  name="name"
                  value={formData.name}
              ...
              <div className="mb-6">
                <label className="block text-sm font-light text-brown mb-2">Phone Number *</label>
                <input
                  type="tel"
                  name="phone"
              ...
              <div className="grid grid-cols-2 gap-4 mb-6">
                <div>
                  <label className="block text-sm font-light text-brown mb-2">Check-in *</label>
                  <input
                    type="date"
                    name="checkIn"
                ...
                <div>
                  <label className="block text-sm font-light text-brown mb-2">Check-out *</label>
                  <input
                    type="date"
                    name="checkOut"
              ...
              <div className="mb-6">
                <label className="block text-sm font-light text-brown mb-2">Room Type *</label>
                <select
                  name="roomType"
              ...
              <div className="mb-6">
                <label className="block text-sm font-light text-brown mb-2">Message</label>
                <textarea
                  name="message"
